...
export default function AuthSimpleLayout({
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-sky-100 p-6">
            <div className="w-full max-w-sm bg-white/90 backdrop-blur rounded-xl shadow-lg p-8">
